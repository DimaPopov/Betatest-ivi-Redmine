...
(function () {
  ...
  */
  ...
  function formatDate(date) {
    ...
    var yyyyy = date.getFullYear() % 10000;
  ...
  const editEventTabsIVI = function () {
    const tabsIVI = $(this).parent();
    const value = $(this).attr('data-value');
    const select = tabsIVI.parent().find('select');
    
    select.val(value);
    tabsIVI.find('active').removeClass('active');
    $(this).addClass('active');
  }
  ...
  */
  ...
  var hideMenuChildren = function () {
    const element = $(this).find('.menu-children');
    
    element.css('height', 0);
  }
  
  var showMenuChildren = function () {
    const element = $(this).find('.menu-children');
  ...
  */
  ...
  if (url == projects) {
    ...
    projectsList.find('.project').each(function (project) {
  ...
  */
  ...
  if (url == account) {
    ...
    var formRemoveSelectElement =  contentElement.find('form #user_language');
    formRemoveSelectElement.parent().remove();
    
    var formRemoveSelectElement =  contentElement.find('form #pref_textarea_font');
    formRemoveSelectElement.parent().remove();
    
    var formRemoveSelectElement =  contentElement.find('form #user_custom_field_values_35');
    formRemoveSelectElement.parent().remove();
    
    var formRemoveSelectElement =  contentElement.find('form #pref_time_zone');
    formRemoveSelectElement.parent().remove();
  ...
  */
  ...
  if (url.indexOf('users/') !== -1) {
    ...
    nameUserElement.wrap('<div class="info--user--flex--block"><div class="info--user--flex--block__left"></div></div>');
    ...
    var numberElement = email.indexOf('@') == -1 ? 1 : 2;
    
    const iviID = splitcontentleftElement.find('ul:nth-child(1) > li:nth-child(' + numberElement + ')').text().replace(/[\s.,.,-,ivi ID:]/g, '');
    numberElement++;
        
    numberElement++;
    var lastOnlintTime = splitcontentleftElement.find('ul:nth-child(1) > li:nth-child(' + numberElement + ')').text().replace(/Последнее подключение: /g,'').split(".");
